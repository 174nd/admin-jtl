...
import { MdDateRange, MdOutlineSentimentVerySatisfied, MdOutlineWorkHistory } from "react-icons/md";
import { FaArrowLeft, FaArrowRight, FaPencilAlt, FaRegEye } from "react-icons/fa";
import ModalSelectPenilaianKinerja from "@/components/dashboard/ModalSelectPenilaianKinerja";
...
export default function ProfileKaryawan() {
  ...
  const [openModalPenilaian, setOpenModalPenilaian] = useState<boolean>(false);
  return(
    ...
    <div className="my-4 flex flex-col md:flex-row space-y-0 space-x-0 md:space-x-4">
      ...
      <div className="flex flex-col w-full md:w-1/3 gap-4">
        ...
        <Button className="w-full rounded-lg bg-green-500 hover:bg-green-600" onClick={() => {setOpenModalPenilaian(!openModalPenilaian); addModal()}}>
          Penilaian Kinerja
        </Button>

        <ModalProfile openModal={openModal} closeModal={() => {setOpenModal(!openModal); removeModal()}}/>

        <ModalSelectPenilaianKinerja data={{
          name      : "ABCDE1",
          position  : "BBC1234",
          time      : new Date(),
          questions : [{
        ...
        } openModal={openModalPenilaian} closeModal={() => {setOpenModalPenilaian(!openModalPenilaian); removeModal()}}/>
