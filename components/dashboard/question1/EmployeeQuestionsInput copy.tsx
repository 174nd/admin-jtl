...
// export default function EmployeeQuestionsInput({data}: {data: EmployeeQuestionType[]}) {
...
//               <Draggable draggableId={questionGroup.id} key={questionGroup.id} index={questionGroupIndex} >
//                 {dragProv => (
//                   <div {...dragProv.draggableProps} {...dragProv.dragHandleProps} className="bg-white rounded-lg shadow-xl block overflow-x-auto md:mt-0 p-8" key={questionGroup.id} ref={dragProv.innerRef}>
//                     <Droppable droppableId={questionGroup.id} type='question'>
//                       {dropProv => (
//                         <div ref={dropProv.innerRef}>
//                           <h4 className="text-xl text-gray-900 font-bold">{questionGroup.title}</h4>
                
//                           {questionGroup.questions.map((question, questionIndex) => (
//                             <Draggable draggableId={questionGroup.id + '||' + question.id} index={questionIndex} >
//                             {dragProv => (
//                               <div {...dragProv.draggableProps} ref={dragProv.innerRef}>
//                                 <Droppable droppableId={questionGroup.id + '||' + question.id} type='AnswerKey'>
//                                   {dropProv => (
...
//                                             <Draggable draggableId={questionGroup.id + '||' + question.id + '||' + answer.id} index={answerIndex}>
//                                             {dragProv => (
...
//                                             )}
//                                             </Draggable>
//                                             // <AnswerKey key={answerIndex} data={answer} index={answerIndex} questionGroupId={props.questionGroupId} questionId={question.id} />
//                                           ))}
