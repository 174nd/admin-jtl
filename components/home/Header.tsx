  ...
  return (
    ...
    <div className="container mx-auto py-4">
      <div className="flex intems-center justify-between ">
        <div className="px-4">
          <a href="#home" className="font-bold text-lg text-primary-500 flex items-center">
        ...
        <div className="flex items-center px-4">
          ...
          <nav id="nav-menu"
            ...
            <ul className="block lg:flex">
              <li className="group">
                <a href="#home"
                  className="text-base textneutral-900 py-2 mx-8 flex group-hover:text-primary-500">Struktur Perusahaan</a>
              </li>
              <li className="group">
